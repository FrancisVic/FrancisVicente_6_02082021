...
function generatePhotographer(value) {
    ...
    while (value.photographers.length > j) {
        ...
        let containerHashtag = document.createElement('div');
        containerHashtag.classList.add('containerHashtag');
        let i = 0;
        while (value.photographers[j].tags.length > i) {
            ...
            console.log(hashtag);
            containerHashtag.appendChild(hashtag);
            i++;
        }
        describe.appendChild(containerHashtag);
        j++;
    }
